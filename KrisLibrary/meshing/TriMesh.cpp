...
* @File Path M:\MAS2\embedded Klampt\KrisLibrary\meshing\TriMesh.cpp
* @Author: Ruige_Lee
* @Date:   2019-05-19 11:47:45
* @Last Modified by:   Ruige_Lee
* @Last Modified time: 2019-05-21 19:55:10
...
bool LoadTriMesh(FILE* f,TriMesh& tri)
{
	...
	//read in first line num of point
	if(fscanf(f,"%d",&numverts) <= 0)
	{
		return false;
	}
	//limit num of input 
